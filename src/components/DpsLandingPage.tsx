...
export default function DpsLandingPage() {
  // =========================================================================
  // PANDUAN UNTUK ANDA (LANDING PAGE /dps):
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans selection:bg-indigo-500/30 selection:text-indigo-200 overflow-x-hidden pb-24 relative">
      
      {/* Decorative Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl h-[600px] bg-gradient-to-b from-indigo-500/5 via-transparent to-transparent pointer-events-none blur-3xl" />
      ...
      <header className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 relative z-20 flex justify-between items-center">
        <a href="/" className="flex items-center gap-2 group">
          ...
          <span className="text-xs bg-slate-800 text-slate-400 px-2 py-0.5 rounded border border-slate-700 font-mono">DPS</span>
        </a>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 sm:pt-16 relative z-10">
        ...
        <div className="text-center space-y-4 mb-12">
          <motion.div 
            ...
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-xs font-semibold tracking-widest uppercase"
          >
            <Sparkles className="w-4 h-4 text-indigo-400 animate-pulse" />
            Jalur /dps Sudah Aktif!
          </motion.div>
          ...
          >
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-white uppercase">
              Landing Page DPS Baru
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-indigo-300 to-indigo-500 mt-1">
                Akan Tampil Di Sini
              </span>
            </h1>
            <p className="text-lg sm:text-xl font-medium text-slate-400 tracking-wider uppercase pt-2">
              Dikelola oleh file /src/components/DpsLandingPage.tsx
            </p>
          </motion.div>
        </div>
        ...
        >
          <h3 className="text-xl font-bold text-white flex items-center gap-2 border-b border-slate-800/80 pb-3">
            ...
            Panduan Mengisi Halaman DPS ini:
          </h3>
          ...
          <ol className="space-y-4 text-slate-300 text-sm sm:text-base list-decimal list-inside leading-relaxed">
            ...
            <li>
              Buka file <code className="text-amber-400">/src/components/DpsLandingPage.tsx</code> di editor ini.
            </li>
            <li>
              Gantikan seluruh isi file ini dengan kode yang baru saja Anda salin. Sesuaikan nama fungsinya menjadi <code className="text-amber-400">DpsLandingPage</code>.
            </li>
            <li>
